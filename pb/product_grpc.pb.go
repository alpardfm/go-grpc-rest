...
const (
	...
	ProductService_ListProducts_FullMethodName  = "/product.service.v1.ProductService/ListProducts"
)
...
type ProductServiceClient interface {
	...
	DeleteProduct(ctx context.Context, in *ProductID, opts ...grpc.CallOption) (*ProductID, error)
...
func (c *productServiceClient) DeleteProduct(ctx context.Context, in *ProductID, opts ...grpc.CallOption) (*ProductID, error) {
	out := new(ProductID)
...
type ProductServiceServer interface {
	...
	DeleteProduct(context.Context, *ProductID) (*ProductID, error)
...
func (UnimplementedProductServiceServer) DeleteProduct(context.Context, *ProductID) (*ProductID, error) {
